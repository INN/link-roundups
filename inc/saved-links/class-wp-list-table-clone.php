<?php
/**
 * For Saved_Links_List_Table
 * Copied from WordPress' WP_List_Table class, tag 5.1.1
 *
 * Administration API: clone_WP_List_Table class
 *
 * @package WordPress
...
<p class="search-box">
	...
	/**
	 * Public wrapper for clone_WP_List_Table::get_default_primary_column_name().
	 *
	 * @since 4.4.0
	 *
...
<table class="wp-list-table <?php echo implode( ' ', $this->get_table_classes() ); ?>">
	...
	/**
	 * Get a list of CSS classes for the clone_WP_List_Table table tag.
	 *
	 * @since 3.1.0
	 *
